# COMMENTS
{
  ...
  DATA_TRANSFORM_COMMENT = p("Transform the data into five different formats 1) count, 2) count (rarefied), 3) proportion, 
                             4) CLR (centered log ratio) (Aitchison, 1982), 5) arcsin square root for each taxonomic rank (phylum, class, order, familiy, genus, species).")
  ...
  Surv_Time__Comment = p( "A variable for follow-up time.", style = "font-size:11pt")
  Surv_CensorComment = p("A binary indicator for censored (0) or event (1).", style = "font-size:11pt")
  Follow_Time__Comment = p("You can reset the follow-up period of interest or leave it as it is.", style = "font-size:11pt")
  Num_PredComment = p("The maximum number of predictors to be displayed on the importance plot.", style = "font-size:11pt")
}
